...
public class JwtService {
    private static final String SECRET_KEY = "d644a8d6b447d2e99ac1895d60ae0cc37694bd5a12b6fc923c1a791c36c6c8d0";
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails){
        return Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 24))  //24 óra + 1000 ms
